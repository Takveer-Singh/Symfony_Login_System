 ...
 */
final class Version20220622155928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE students (id INT AUTO_INCREMENT NOT NULL, class_id_id INT NOT NULL, admission_number INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_A4698DB29993BF61 (class_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
